...
public class DialogueManagerCap3Scoiattoli : MonoBehaviour
{
    [Header("Dialogue UI")]
    ...
    private static DialogueManagerCap3Scoiattoli instance;
    ...
    public static DialogueManagerCap3Scoiattoli GetInstance(){
            return instance;
    }
    ...
    private void Start(){
        ...
        StartCoroutine(startDialogueScoiattoli());
    }


    private IEnumerator startDialogueScoiattoli(){
